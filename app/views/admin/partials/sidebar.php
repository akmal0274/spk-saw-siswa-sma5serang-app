...
<ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
    <div class="sidebar-brand d-flex align-items-center justify-content-center my-2">
        <img src="/apksawsmanli/public/assets/logo.png" alt="Logo Sekolah" style="max-width: 60px;">
    ...
    <li class="nav-item <?= is_active('AdminDashboard') ?>">
        <a class="nav-link" href="/apksawsmanli/admin/dashboard">
    ...
    <li class="nav-item <?= is_active('AdminSiswa') ?>">
        <a class="nav-link" href="/apksawsmanli/admin/siswa">
    ...
    <li class="nav-item <?= is_active('AdminKriteria') ?>">
        <a class="nav-link" href="/apksawsmanli/admin/kriteria">
    ...
    <li class="nav-item <?= is_active('AdminSubkriteria') ?>">
        <a class="nav-link" href="/apksawsmanli/admin/subkriteria">
    ...
    <li class="nav-item <?= is_active('AdminAlternatif') ?>">
        <a class="nav-link" href="/apksawsmanli/admin/alternatif">
    ...
    <li class="nav-item <?= is_active('AdminSaw') ?>">
        <a class="nav-link" href="/apksawsmanli/admin/saw">
    ...
    <li class="nav-item <?= is_active('AdminRankingakhir') ?>">
        <a class="nav-link" href="/apksawsmanli/admin/rankingakhir">
